    ...
    <template>
        <custom-style>
            <style is="custom-style">
                ...
                .flag-icon-gu {
                    background-image: url(icons/gu.svg);
                }
                ...
                .flag-icon-mh {
                    background-image: url(icons/mh.svg);
                }
                ...
                .flag-icon-mp {
                    background-image: url(icons/mp.svg);
                }
                ...
                .flag-icon-pr {
                    background-image: url(icons/pr.svg);
                }
                ...
                .flag-icon-pw {
                    background-image: url(icons/pw.svg);
                }
                ...
                .flag-icon-vi {
                    background-image: url(icons/vi.svg);
                }
                ...
                .flag-icon-un {
                    background-image: url(icons/un.svg);
                }
            </style>
        </custom-style>
    </template>
